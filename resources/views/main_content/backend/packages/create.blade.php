...
@section('pageTitle',_lang('app.add_packages'))

@section('breadcrumb')
<li><a href="{{url('admin')}}">{{_lang('app.dashboard')}}</a> <i class="fa fa-circle"></i></li>

<li><a href="{{route('packages.index')}}">{{_lang('app.packages')}}</a> <i class="fa fa-circle"></i></li>
        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                <div class="form-group form-md-line-input col-md-4">
                    <input type="number" class="form-control" id="num_of_ads" name="num_of_ads" value="">
