     ...
     <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                ...
                <div class="form-group form-md-line-input col-md-6">
                    <input type="text" class="form-control" id="sign[{{ $key }}]" name="sign[{{ $key }}]" value="{{ $translations["$key"]->sign }}">
        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                <div class="form-group form-md-line-input col-md-4">
                    <input type="number" class="form-control" id="this_order" name="this_order" value="{{ $currency->this_order }}">
                    <label for="this_order">{{_lang('app.this_order') }}</label>
                    <span class="help-block"></span>
                </div>
                <div class="form-group form-md-line-input col-md-3">
                    <select class="form-control edited" id="active" name="active">
                        <option {{ $currency->active == 1 ?'selected' : '' }} value="1">{{ _lang('app.active') }}</option>
                        <option {{ $currency->active == 0 ?'selected' : '' }} value="0">{{ _lang('app.not_active') }}</option>
                    </select>
